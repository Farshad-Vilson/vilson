...
(function($) {
    ...
    function buildDetailHtml(m, icons) {
        ...
        return '<div class="markil-panel-content">' +
            ...
            '<div class="markil-panel-actions"><a href="' + escAttr(btn1Href) + '" class="markil-btn-primary">' + btn1Text + '</a><a href="' + escAttr(btn2Href) + '" class="markil-btn-secondary">' + btn2Text + '</a></div>' +
        '</div>';
    }
