...
{$p} .ha-pro-sort { all:unset !important; display:inline-block !important; padding:9px 14px !important; border:1px solid #e5e7eb !important; border-radius:999px !important; font-size:12.5px !important; color:#011627 !important; background:#fff !important; cursor:pointer !important; font-family:IRANYekan,Vazirmatn,Tahoma,system-ui,sans-serif !important; direction:rtl !important; -webkit-appearance:auto !important; appearance:auto !important; }
...
{$p} .ha-pro-card { background:#fff !important; border:1px solid #e5e7eb !important; border-radius:12px !important; box-shadow:0 1px 3px rgba(15,23,42,.06) !important; padding:12px !important; overflow:visible !important; min-height:100% !important; gap:0 !important; transition:transform .85s cubic-bezier(.22,1,.36,1), box-shadow .85s cubic-bezier(.22,1,.36,1), border-color .7s ease !important; will-change:transform !important; }
{$p} .ha-pro-card:hover { transform:translateY(-5px) !important; border-color:#011627 !important; box-shadow:0 14px 34px rgba(1,22,39,.16) !important; transition:transform .55s cubic-bezier(.22,1,.36,1), box-shadow .55s cubic-bezier(.22,1,.36,1), border-color .4s ease !important; }
