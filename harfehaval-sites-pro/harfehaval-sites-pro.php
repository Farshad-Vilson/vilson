 ...
 * Description: نمایش پیشرفته نمونه‌سایت‌ها با ویجت المنتور کامل — فیلتر، جستجو، اسکرول hover روی تصویر، مودال پیش‌نمایش، مقایسه، علاقه‌مندی، استایل ایزوله و صدها تنظیم المنتوری.
 * Version:     3.3.2
 * Author:      فرشاد معتمدی
...
define( 'HA_SITES_PRO_VERSION',  '3.3.2' );
